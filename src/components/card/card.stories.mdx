...
<Meta title="MDX/UI/Card" component={Card} />
...
# h1
The `h1` component is simply a heading to be used inside a card. It's that simple. Programmer Interface identical to the HTML `<h1>` tag.