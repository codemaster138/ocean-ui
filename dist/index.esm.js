import React, { useContext, useMemo, useRef, useDebugValue, createElement, forwardRef, useState } from 'react';
...
var StyledInputContainer = Ye.div(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["\n  width: 100%;\n  position: relative;\n"], ["\n  width: 100%;\n  position: relative;\n"])));
var StyledInputLabel = Ye.label(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["\n  font-size: 13px;\n  color: ", ";\n  display: block;\n  margin-top: ", ";\n  margin-bottom: 8px;\n"], ["\n  font-size: 13px;\n  color: ", ";\n  display: block;\n  margin-top: ", ";\n  margin-bottom: 8px;\n"])), function (p) { return (p.error ? p.theme.col_red : p.theme.accent_1); }, function (p) { return (p.error ? "8px" : "24px"); });
var StyledInput = Ye.input(templateObject_3$3 || (templateObject_3$3 = __makeTemplateObject(["\n  width: 100%;\n  background-color: transparent;\n  font-size: 15px;\n  color: ", ";\n  padding: 10px 18px;\n  border-radius: 5px;\n  border: 1px solid ", ";\n  box-sizing: border-box;\n  transition: 300ms;\n  box-shadow: 0px 0px 0px 0px ", ";\n\n  &::placeholder {\n    color: ", ";\n  }\n\n  &:focus {\n    outline: none;\n    border-color: ", ";\n    box-shadow: 0px 0px 4px 0px ", ";\n  }\n\n  &:disabled {\n    cursor: not-allowed;\n  }\n"], ["\n  width: 100%;\n  background-color: transparent;\n  font-size: 15px;\n  color: ", ";\n  padding: 10px 18px;\n  border-radius: 5px;\n  border: 1px solid ", ";\n  box-sizing: border-box;\n  transition: 300ms;\n  box-shadow: 0px 0px 0px 0px ", ";\n\n  &::placeholder {\n    color: ", ";\n  }\n\n  &:focus {\n    outline: none;\n    border-color: ", ";\n    box-shadow: 0px 0px 4px 0px ", ";\n  }\n\n  &:disabled {\n    cursor: not-allowed;\n  }\n"])), function (p) { return p.theme.fg; }, function (p) { return (p.error ? p.theme.col_red : p.theme.accent_2); }, function (p) { return p.theme.primary + "a0"; }, function (p) { return p.theme.accent_2; }, function (p) { return p.theme.primary; }, function (p) { return p.theme.primary + "a0"; });
var TogglePasswordButton = Ye.a(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  text-decoration: none;\n  border: none;\n  background-color: transparent;\n  position: absolute;\n  top: 50%;\n  left: calc(100% - 40px);\n  transform: translateY(-50%);\n  cursor: pointer;\n\n  svg {\n    width: 15px;\n    color: ", ";\n  }\n\n  &:hover {\n    svg {\n      color: ", ";\n    }\n  }\n\n  &:focus {\n    outline: none;\n  }\n"], ["\n  text-decoration: none;\n  border: none;\n  background-color: transparent;\n  position: absolute;\n  top: 50%;\n  left: calc(100% - 40px);\n  transform: translateY(-50%);\n  cursor: pointer;\n\n  svg {\n    width: 15px;\n    color: ", ";\n  }\n\n  &:hover {\n    svg {\n      color: ", ";\n    }\n  }\n\n  &:focus {\n    outline: none;\n  }\n"])), function (p) { return p.theme.accent_1; }, function (p) { return p.theme.accent_2; });
var StyledInputInner = Ye.div(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
var index$1 = forwardRef(function (_a, ref) {
    var value = _a.value, update = _a.update, label = _a.label, placeholder = _a.placeholder, type = _a.type, error = _a.error, onFocus = _a.onFocus, onKeyDown = _a.onKeyDown, disabled = _a.disabled, errorOutline = _a.errorOutline;
    ...
    return (React.createElement(StyledInputContainer, { className: "input-container" },
        ...
        React.createElement(StyledInputInner, null,
            React.createElement(StyledInput, { class: "input-container_input", onFocus: onFocus, ref: ref, error: error ? true : errorOutline, type: type === "password" ? (passwordShown ? "text" : "password") : type, placeholder: placeholder, value: value, onChange: function (e) { return update === null || update === void 0 ? void 0 : update(e.target.value); }, onKeyDown: onKeyDown, disabled: disabled }),
...
var StyledCard = Ye.div(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n  box-sizing: border-box;\n  padding: 0;\n  margin: 0;\n  width: ", ";\n  background: ", ";\n  box-shadow: 0px 5px 10px ", ";\n  border-radius: 10px;\n  position: relative;\n  font-size: 13px;\n  overflow: initial;\n"], ["\n  box-sizing: border-box;\n  padding: 0;\n  margin: 0;\n  width: ",
    ";\n  background: ", ";\n  box-shadow: 0px 5px 10px ", ";\n  border-radius: 10px;\n  position: relative;\n  font-size: 13px;\n  overflow: initial;\n"])), function (p) {
...
var StyledCardBody = Ye.div(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n  box-sizing: border-box;\n  width: 100%;\n  padding: ", ";\n  padding-bottom: ", ";\n\n  p {\n    color: ", ";\n  }\n\n  & > :first-child {\n    margin-top: 0;\n  }\n\n  & > :last-child {\n    margin-bottom: 0;\n  }\n  position: relative;\n  /* padding-top: ", "; */\n"], ["\n  box-sizing: border-box;\n  width: 100%;\n  padding: ", ";\n  padding-bottom: ",
...
var templateObject_1$4, templateObject_2$2, templateObject_3$2, templateObject_4, templateObject_5, templateObject_6;

var StyledOceanRoot = Ye.div(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["\n  width: 100%;\n  background: ", ";\n  box-sizing: border-box;\n\n  .button + .button,\n  .icon-button + .button {\n    margin-left: 16px;\n  }\n\n  * + .checkbox,\n  * + .separator,\n  * + .radio,\n  * + .div,\n  * + .toggle {\n    margin-top: 16px;\n  }\n\n  * {\n    font-family: \"Roboto\", -apple-system, BlinkMacSystemFont, \"Segoe UI\",\n      \"Roboto\", \"Oxygen\", \"Ubuntu\", \"Cantarell\", \"Fira Sans\", \"Droid Sans\",\n      \"Helvetica Neue\", sans-serif;\n\n    -webkit-font-smoothing: antialiased;\n    -moz-osx-font-smoothing: grayscale;\n  }\n"], ["\n  width: 100%;\n  background: ", ";\n  box-sizing: border-box;\n\n  .button + .button,\n  .icon-button + .button {\n    margin-left: 16px;\n  }\n\n  * + .checkbox,\n  * + .separator,\n  * + .radio,\n  * + .div,\n  * + .toggle {\n    margin-top: 16px;\n  }\n\n  * {\n    font-family: \"Roboto\", -apple-system, BlinkMacSystemFont, \"Segoe UI\",\n      \"Roboto\", \"Oxygen\", \"Ubuntu\", \"Cantarell\", \"Fira Sans\", \"Droid Sans\",\n      \"Helvetica Neue\", sans-serif;\n\n    -webkit-font-smoothing: antialiased;\n    -moz-osx-font-smoothing: grayscale;\n  }\n"])), function (p) { return p.theme.bg; });
function OceanRoot(_a) {
    var theme = _a.theme, children = _a.children;
    return (React.createElement(Le, { theme: theme },
        React.createElement(StyledOceanRoot, null, children)));
}
var templateObject_1$3;

var StyledCheckboxContainer = Ye.label(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n  width: 100%;\n  display: flex;\n  align-items: center;\n  justify-content: flex-start;\n  flex-flow: row;\n  cursor: pointer;\n"], ["\n  width: 100%;\n  display: flex;\n  align-items: center;\n  justify-content: flex-start;\n  flex-flow: row;\n  cursor: pointer;\n"])));
var StyledCheckbox = Ye.button(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  padding: 2px;\n\n  background: transparent;\n  width: 16px;\n  height: 16px;\n  border-radius: 3px;\n  border: 1px solid ", ";\n  transition: 300ms;\n\n  svg {\n    color: ", ";\n    opacity: 0;\n    width: 5px;\n    height: 5px;\n    transition: 300ms;\n  }\n\n  &:hover {\n    cursor: pointer;\n    border-color: ", ";\n  }\n\n  &.checkbox__checkbox--checked {\n    border-color: ", ";\n    background: ", ";\n\n    svg {\n      width: 14px;\n      height: 14px;\n      opacity: 1;\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  padding: 2px;\n\n  background: transparent;\n  width: 16px;\n  height: 16px;\n  border-radius: 3px;\n  border: 1px solid ", ";\n  transition: 300ms;\n\n  svg {\n    color: ", ";\n    opacity: 0;\n    width: 5px;\n    height: 5px;\n    transition: 300ms;\n  }\n\n  &:hover {\n    cursor: pointer;\n    border-color: ", ";\n  }\n\n  &.checkbox__checkbox--checked {\n    border-color: ", ";\n    background: ", ";\n\n    svg {\n      width: 14px;\n      height: 14px;\n      opacity: 1;\n    }\n  }\n"])), function (p) { return p.theme.accent_2; }, function (p) { return p.theme.on_primary; }, function (p) { return p.theme.accent_1; }, function (p) { return p.theme.primary; }, function (p) { return p.theme.primary; });
var StyledCheckboxLabel = Ye.span(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n  margin-left: 12px;\n  font-size: 13px;\n  padding-bottom: 1px;\n  color: ", ";\n  transition: 300ms;\n\n  &.checkbox__label--checked {\n    color: ", ";\n  }\n"], ["\n  margin-left: 12px;\n  font-size: 13px;\n  padding-bottom: 1px;\n  color: ", ";\n  transition: 300ms;\n\n  &.checkbox__label--checked {\n    color: ", ";\n  }\n"])), function (p) { return p.theme.accent_1; }, function (p) { return p.theme.fg; });
...
var StyledSeparator = Ye.hr(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  width: 100%;\n  border: none;\n  height: 1px;\n  border-top: 1px solid ", ";\n  margin: 0;\n  padding: 0;\n"], ["\n  width: 100%;\n  border: none;\n  height: 1px;\n  border-top: 1px solid ", ";\n  margin: 0;\n  padding: 0;\n"])), function (p) { return p.theme.accent_2; });
...
export { Button, Card, CardForm, CardHeading, index as Checkbox, IconButton, index$1 as Input, OceanRoot, Separator, StepBar, ToggleSwitch, light as defaultLightTheme };
