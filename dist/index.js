...
function OptionSwitch(props) {
    return (React__default['default'].createElement(StyledOptionSwitchWrapper, { className: "option-switch" },
...
var StyledSwitchOption = Ye.button(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  border: none;\n  background-color: ", ";\n  color: ", ";\n  border-radius: 5px;\n  padding: 8px 16px;\n  font-size: 13px;\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  margin: 0;\n  transition: 300ms;\n\n  cursor: pointer;\n"], ["\n  border: none;\n  background-color: ",
    ";\n  color: ", ";\n  border-radius: 5px;\n  padding: 8px 16px;\n  font-size: 13px;\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  margin: 0;\n  transition: 300ms;\n\n  cursor: pointer;\n"])), function (p) {
