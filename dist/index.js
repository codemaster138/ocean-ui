...
var index$1 = React.forwardRef(function (_a, ref) {
...
function Card(props) {
    return (React__default['default'].createElement(StyledCard, __assign({}, __assign(__assign({}, props), { children: undefined })),
        ...
        React__default['default'].createElement(StyledCardBody, { compact: props.compact, hasFooter: props.footer ? true : false }, props.children),
...
function OceanRoot(_a) {
    ...
    return (React__default['default'].createElement(Le, { theme: theme },
